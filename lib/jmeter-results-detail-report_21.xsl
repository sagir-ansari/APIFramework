				   ...
				   <a href="">
			         ...
			         <xsl:for-each select="../*[@lb = $label and @tn != $label]">
			            <tr>
			               ...
			               <td align="center" style="white-space:pre-wrap; word-wrap:break-word"><xsl:value-of select="position()" /></td>
			               <td align="center" style="white-space:pre-wrap; word-wrap:break-word"><xsl:value-of select="./method" /></td>
			               <td align="center" style="white-space:pre-wrap; word-wrap:break-word"><xsl:value-of select="./java.net.URL" /></td>
			               <td align="center" style="white-space:pre-wrap; word-wrap:break-word"><xsl:value-of select="./requestHeader" /></td>
			               <td align="center" style="white-space:pre-wrap; word-wrap:break-word"><xsl:value-of select="./responseData" /></td>
			               <td align="center" style="white-space:pre-wrap; word-wrap:break-word"><xsl:value-of select="./responseHeader" /></td>
			               <td align="right" style="white-space:pre-wrap; word-wrap:break-word"><xsl:value-of select="@t" /></td>
